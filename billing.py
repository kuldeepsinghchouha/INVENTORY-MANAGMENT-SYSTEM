...
#IMAGE
        ...
        title=Label(self.root,text="Inventory Management System",image=self.icon_title,compound=LEFT,font=("times new romans",40,"bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
#LOGOUT BUTTON      
        ...
        self.lbl_clock=Label(self.root,text="Welcome to Inventory Management Sytem\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new romans",15),bg="#4d636d",fg="white")
        ...
        btn_add_cart=Button(Add_CartwidgetsFrame,text="Add | Update Cart",command=self.add_upate_cart,font=("times new roman",15,"bold"),bg="orange",cursor="hand2").place(x=340,y=70,width=180,height=30)
        ...
        ####footer####
        footer=Label(self.root,text="IVS Inventory Management System | developed by Kuldeep\nFor any Techincal Issue contact 8517xxxxx25",font=("times new roman",11),bg="#4d636d",fg="white",bd=0,cursor="hand2").pack(side=BOTTOM,fill=X)
        self.show()
    ...
    def generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            fp=open('bill/{str(self.invoice)}.txt','w')
...
{str("="*47)}\n
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(text=f"welcome to Inventory Management Sytem\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
