...
#LOGOUT BUTTON      
        ...
        lbl_footer=Label(self.root,text="SMS-Inventory Management System | Developed by Kuldeep",font=("times new romans",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.update_content()
############################################################################
    def employee(self):
