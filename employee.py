...
#TITLE
        ...
        cmb_search=ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values=("Name","Male","Female","Other"),state='readonly',justify=CENTER,font=("times new roman",15))
